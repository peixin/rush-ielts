...
export default function Import() {
  ...
  // Default to 1, will update on load
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (data.error) {
            ...
            // Save to DB with Collection ID
            const wordToSave = { ...data, collectionId: selectedCollectionId };
      ...
      <div className="max-w-2xl mx-auto w-full space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link to="/collections" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">← Back</Link>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-blue-500 transition-shadow"
            >
              {collections.map(c => (
        ...
        {(successCount > 0 || failedWords.length > 0) && (
          <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 animate-in fade-in slide-in-from-bottom-4">
            ...
            {!isProcessing && (
              <div className="mb-6">
                <Link
                  to={`/vocabulary?collectionId=${selectedCollectionId}`}
